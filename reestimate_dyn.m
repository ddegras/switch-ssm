function [Ahat,Chat,Qhat,Rhat,muhat,Sigmahat,Pihat,Zhat] = ...
    reestimate_dyn(y,M,p,r,S,control,equal,fixed,scale)
...
test = preproc_dyn(M,N,p,r,Ahat,Chat,Qhat,Rhat,muhat,Sigmahat,Pihat,Zhat,...
    control,equal,fixed,scale); %#ok<NASGU>
